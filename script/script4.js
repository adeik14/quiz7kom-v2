...
function displayResult() {
  ...
  if (score >= 2) {
    resultContainer.innerHTML = '<h4>Anda bisa melanjutkan ke kompetensi selanjutnya </h4> <a href="quiz5.html"><span>Keterampilan Klasifikasi Klinis, Kodifikasi Penyakit dan Prosedur</span></a>';
  } else {
