const quizData = [
  ...
  {
    question: 'Dalam hal pengembangan diri seorang perekam medis hendaknya:',
    options: [
      'Selalu mengasah skill dan pengetahuan baru',
      'Menjaga kompetensi',
      'Menganggap bahwa diam dapat mengambangkan diri ',
      'Tidak peduli',
    ],
    answer: 'Selalu mengasah skill dan pengetahuan baru',
  },
...
function displayResult() {
  ...
  if (score >= 2) {
    resultContainer.innerHTML = '<h4>Anda bisa melanjutkan ke kompetensi selanjutnya </h4> <a href="quiz3.html"><span>Komunikasi Efektif</span></a>';
  } else {
