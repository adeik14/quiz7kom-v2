...
function displayResult() {
  ...
  if (score >= 2) {
    resultContainer.innerHTML = '<h4>Anda bisa melanjutkan ke kompetensi selanjutnya </h4> <a href="quiz6.html"><span>Aplikasi Statistik Kesehatan, Epidemiologi Dasar dan Biomedik</span></a>';
  } else {
